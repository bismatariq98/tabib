                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Center(child: Text("9.3",style: TextStyle(color: Colors.white),)),
                          ),
                              SmoothStarRating(
          rating: rating,
          isReadOnly: false,
              ...
              // print("rating value dd -> ${value.truncate()}");
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                       Icon(Icons.wifi,color: Color(0xFFA2ABD7),size: 34,),
                       Expanded(child: Text("Heading And descripton lorem ipsumadnlakdlk "))
                    ],) ,
                    ),
                  )
               ],
